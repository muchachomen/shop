...
from .views import ProfileView, ProductList, Categoryview, Cartview, Products, DetailView, Orderlist, Reviews, Cartlist, CreateOrderView, ProcessOrderView
...
urlpatterns = [
    ...
    path('orders/', ProcessOrderView.as_view())
]
